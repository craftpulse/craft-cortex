...
A successful `initialize` handshake reports `cortex 5.0.0` and protocol `2025-06-18`. On a Free install `tools/list` returns 33 entries; `prompts/list` returns 10; `resources/list` returns 98.
