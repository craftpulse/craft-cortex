...
A successful `initialize` handshake reports `cortex 5.0.0` and protocol `2025-06-18`. On a Free install `tools/list` returns 33 entries; `prompts/list` returns 8; `resources/list` returns 77.
